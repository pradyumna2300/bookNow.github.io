...
public class AppointmentDao {
	 ...
	 public static int save(AppointmentBean ab){  
	        ...
	        try{  
	            ...
	            PreparedStatement ps=con.prepareStatement(  				//Table =appointment
	                         "insert into appointment(apid,name,email,contact,age,day,speciality,description,dayssinceinfected,time,id) values(appoint.nextval,?,?,?,?,?,?,?,?,?,?)");  
	            ...
	            ps.setString(8,ab.getDayssinceinfected());
	            ps.setString(9,ab.getTime());
	            ps.setInt(10, ab.getId());
	 ...
	 public static ArrayList<AppointmentBean> getAppointmentbyemail(String email)
	 {
	 	...
	 	try {
           ...
           //     app.setDayssinceinfected(rs.getString(9));
                app.setId(rs.getInt(9));
                app.setTime(rs.getString(10));
	 			list.add(app);
	 		}
	 	} catch (Exception e) {
	 		e.printStackTrace();
	 ...
	 public static ArrayList<AppointmentBean> getAppointById(int id)
	 {
	  ...
	  public static ArrayList<AppointmentBean> getAppointmentbye(String email)
		 {
		 	ArrayList<AppointmentBean> list=new ArrayList<>();
		 	try {
		 		Connection con=ConnectionProvider.getConnection();
		 		...
		 		while (rs.next()) {
	                ...
	                app.setDescription(rs.getString(8));
	                app.setId(rs.getInt(9));
	                app.setDayssinceinfected(rs.getString(10));
