...
<body bgcolor="#f59da1">
	...
	<%  
		...
		<tr><td>DaysSinceInfected</td><td><textarea name="dayssinceinfected" placeholder="Enter days since you infected .." required="required"></textarea></td></tr>
		<tr><td>Time</td><td><input type="time" id="time" name="time" ></td></tr>
