...
<body bgcolor="#f59da1">
	...
	<div class="container">
		...
		<ul>
			...
			<a href="VAP.jsp"><li class="roundbox">View Appointment</li></a>
	...
	<table>
		<tr><td></td></tr>
		<tr><td>FirstName</td><td><input  type="text" value="<%=prs.getString("firstname")%>" name="firstname" placeholder="First Name" required="required"></td></tr>
		<tr><td>AGE:</td><td><input readonly="readonly" value="<%=prs.getString("age")%>" name="age" required="required"></td></tr>
