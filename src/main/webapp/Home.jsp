...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>HospitalClick - Services</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
        <img src="Img/5.png" style="width: 5vw;">
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 style="text-align:left"> Book Appointment </h1>
            <br>
          </div>
	  <div class="col-md-12" style ="position:relative; left:-400px;">
	   <div class="functional-buttons">
		...
		<div class="text-block" style ="position:relative; left:700px; top:-150px;">
		    
			<br>
			<div class="col-md-12">
	   			<div class="functional-buttons">
            		<ul>
               			<li><a href="AdminLogin.jsp"><b>Admin Login</a></b></li>
